...
namespace ApiCircularGraphQL.Application.DTOs.Usuarios
{
    public class UsuarioCrearDTO
    {
        ...
        public List<HorarioCrearDTO> Horario { get; set; }
        ...
        public List<CategoriaPorUsuarioCrearDTO> Categoria { get; set; }
        ...
        public List<TelefonosUsuariosCrearDTO> Telefono { get; set; }

...
class _$UserCrearStateCopyWithImpl<$Res, $Val extends UserCrearState>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      optiondCategories: null == optiondCategories
          ? _value.optiondCategories
          : optiondCategories // ignore: cast_nullable_to_non_nullable
              as List<BusinessCategory>,
      ...
      selectedDepartamentoId: null == selectedDepartamentoId
          ...
          : selectedDepartamentoId // ignore: cast_nullable_to_non_nullable
              as String,
      selectedMunicipioId: null == selectedMunicipioId
          ? _value.selectedMunicipioId
          : selectedMunicipioId // ignore: cast_nullable_to_non_nullable
              as String,
      selectedLugarId: null == selectedLugarId
...
class _$UserCrearStateImpl implements _UserCrearState {
  ...
  final List<BusinessCategory> _optiondCategories;
  @override
  @JsonKey()
  List<BusinessCategory> get optiondCategories {
    if (_optiondCategories is EqualUnmodifiableListView)
      return _optiondCategories;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_optiondCategories);
  }
